...
预测组合可以利用不同来源的互补信息，组合权重已有基于历史误差的研究\cite{bates1969combination}。光伏预测领域也有模态分解与自适应模型组合方法\cite{wei2026pv}。本题直接提供历史功率和已发布预报，因而采用两来源线性融合，并按历史结算费用选择权重，以对应调度目标。为平衡历史稳定性与预报更新，构造
\begin{equation}
